                    ...
                    <div class="media">
                        <div class="center">
                            <a href="{{ route('users.show',$topic->user->id) }}" class="">
                                <img src="{{ $topic->user->avatar }}" width="300px" height="300px" alt=""
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="operate">
                        ...
                        <form action="{{ route('topics.destroy',$topic->id) }}" method="POST" style="display: inline-block" onsubmit="确定要删除么？">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
