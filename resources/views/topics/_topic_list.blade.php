            ...
            <li class="media">
                <div class="media-left">
                    <a href="{{ route('users.show', [$topic->user_id]) }}">
                        <img src="{{ $topic->user->avatar }}" alt="用户头像" class="media-object img-thumbnail mr-3"
                             style="width: 52px;height: 52px" title="{{ $topic->user->name }}">
                    </a>
                </div>
...
@else
    <div class="empty-block">暂无数据 o(╥﹏╥)o</div>
@endif
